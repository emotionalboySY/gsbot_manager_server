...
app.get('/royal/:iteration', async (req, res) => {
    ...
    console.log(`${getNowDateTime()} - 로얄스타일(${iteration})`);
    let result = {};
...
app.get('/wonder/:iteration', async (req, res) => {
    let iteration = Number(req.params.iteration);
    console.log(`${getNowDateTime()} - 원더베리(${iteration})`);
    let result = {};
...
app.get('/goldApple/:iteration', async (req, res) => {
    let iteration = Number(req.params.iteration);
    console.log(`${getNowDateTime()} - 골드애플(${iteration})`);
    let result = [];
...
app.get('/platinumApple/:iteration', async (req, res) => {
    let iteration = Number(req.params.iteration);
    console.log(`${getNowDateTime()} - 플래티넘애플(${iteration})`);
    let result = [];
...
app.get('/boutique/:iteration', async (req, res) => {
    let iteration = Number(req.params.iteration);
    console.log(`${getNowDateTime()} - 부티크기프트(${iteration})`);
    let result = [];
    ...
    if (iteration > 1000000) {
        ...
        message = `${message}\n총 사용 캐시: ${cost}원\n(1개당 3,300원 기준)\n달콤 생일 케이크를 총 ${totalAmount}개 얻었어요!`;
...
app.get('/event', async (req, res) => {
    console.log(`${getNowDateTime()} - 이벤트`);
...
app.get('/cashShop', async (req, res) => {
    console.log(`${getNowDateTime()} - 캐시샵공지`);
...
app.get("/notice", async (req, res) => {
    ...
    console.log(`${getNowDateTime()} - 공지사항 리스트`);
...
app.get("/update", async (req, res) => {
    ...
    console.log(`${getNowDateTime()} - 업데이트 리스트`);
