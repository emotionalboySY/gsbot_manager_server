...
const helpText = {
    ...
    "시뮬레이션": {
        ...
        "보스 반지 상자": {
            "command": "/녹옥(홍옥/흑옥/백옥/생명) [횟수]",
            "howTo": "[횟수]: 1 ~ 1,000 사이의 숫자\n상자 5종: 녹옥 · 홍옥 · 흑옥 · 백옥 · 생명"
        },
        "연마석": {
            "command": "/연마석 [반지레벨] [연마석개수] [시도횟수]",
            "howTo": "[반지레벨]: 4(4→5 연마) 또는 5(5→6 연마)\n[연마석개수]: 4레벨 0 ~ 10개 / 5레벨 0 ~ 20개\n  → 개수만큼 성공 확률과 소모 메소가 오른다(4레벨 개당 10%·5억, 5레벨 개당 5%·10억)\n[시도횟수]: 1 ~ 20회. 성공하면 그 자리에서 멈춘다."
        },
        "주문서": {
